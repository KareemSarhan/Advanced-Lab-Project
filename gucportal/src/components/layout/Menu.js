    ...
    return (
        ...
        <Card>
            ...
            <Button variant="primary" href="/viewDayOffReq"  class= "mt-10">
                ...
                <br/><br/>
                <Button variant="primary" href="/replacementrequest"  class= "mt-10">
                    View All My Replacement Requests
                </Button>
                <br/><br/>
                <Button variant="primary" href="/sendreplacementreq"  class= "mt-10">
        ...
        <Card>
            ...
            <Button variant="primary" href="/viewCoverage"  class= "mt-10">
                ...
                <br/><br/>
                <Button variant="primary" href="/viewSlotAssignment"  class= "mt-10">
